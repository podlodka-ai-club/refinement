...
1. Агент харнеса (он сам LLM) извлекает из текущей сессии проверенные знания по правилам (extraction-rules / карта проекта) — кандидаты
...
2. Поиск устаревших знаний: факты к которым давно не обращались
...
┌────────────────────▼─────────────────────────┐
│        Агент харнеса (opencode / любой MCP)  │
